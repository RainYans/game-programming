...
/// (native drag-drop lists), then run Tools > Monster Farm > Dress Farm Ground to scatter.
[CreateAssetMenu(fileName = "FarmDressConfig", menuName = "MonsterFarm/Farm Dress Config")]
