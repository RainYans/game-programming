...
[CreateAssetMenu(fileName = "ZombieData", menuName = "MonsterFarm/Zombie Data")]
public class ZombieData : ScriptableObject
{
    ...
    [Header("Lore")]
    [TextArea(2, 5)]
    [Tooltip("Backstory shown in the monster bestiary/codex.")]
    ...
    [Tooltip("Visual size multiplier (1 = normal; >1 for bosses / big enemies).")]
