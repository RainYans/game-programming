...
public class BattleArea : MonoBehaviour
{
    ...
    [Tooltip("Where this area's enemies spawn (single point; used if enemySpawns is empty).")]
    public Transform enemySpawn;
    [Tooltip("Multiple enemy spawn points (round-robin). Takes priority over enemySpawn when set.")]
    ...
    public void Activate()
    {
        ...
        if (spawned.Count > 0) SfxManager.Play(SfxKind.GateOpen); // "here they come" cue on spawn
