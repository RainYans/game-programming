...
public class AvatarController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        float x = (KeyBindings.Held(BindAction.MoveRight) ? 1f : 0f) - (KeyBindings.Held(BindAction.MoveLeft) ? 1f : 0f);
        float y = (KeyBindings.Held(BindAction.MoveUp) ? 1f : 0f) - (KeyBindings.Held(BindAction.MoveDown) ? 1f : 0f);
